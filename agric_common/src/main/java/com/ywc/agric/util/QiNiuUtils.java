...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "Hryzn-gCX0ZkqNZRJd06Jy1lMVYGm0RxCWjmdpgH";//实名认证后的秘钥
    private static final String SECRETKEY = "8aBWrRMlhp2Ocj7Ioc8XWvAoGUNocZOyZFUvUxpQ";//实名认证后的秘钥
    //空间名
    ...
    private static BucketManager getBucketManager(){
        // 创建授权信息
        Auth auth = Auth.create(ACCESSKEY, SECRETKEY);
        // 创建操作某个仓库的管理器//华南2华北1等。。。。。。
        return new BucketManager(auth, new Configuration(Zone.zone1()));
    }

...
public class Menu implements Serializable{
    ...
    private Set<com.ywc.agric.pojo.Role> roles = new HashSet<com.ywc.agric.pojo.Role>(0);//角色集合
    ...
    public Set<com.ywc.agric.pojo.Role> getRoles() {
        return roles;
    }

    public void setRoles(Set<com.ywc.agric.pojo.Role> roles) {
        this.roles = roles;
    }
